######################################
# import from main to just test pzem
######################################
...
print('\n=== PZEM 004T modbus micropython UNIT TEST. version %0.2f. =======\n' %(version))

"""
pzem red led on AC side  = AC

tx, rx side. two red led, labelled RX TX

RX led is on when micropython is idle
when scrip start, RX OFF
then RX and TX blink.
TX blink indicates success (PZEM is sending data)
...
print('use read input register 0x04')
