...
# two ways to use
# 1 as a switch to set deep sleep vs active process/sleep mode. in active sleep mode, webrepl is enabled, and processing is done in while loop
#   ie process; sleep loop

# 2 as a config to either go in deep sleep after processing, or to go in empty endless loop after processing sensor "waiting for REPL command"
#   ie sleep
