...
# oled 60, 0x3c
    ...
    try:
        ...
        # if os.uname().machine in ['LOLIN_S2_PICO with ESP32-S2FN4R2']:

        if reset is not None:
            oled_reset = Pin(18, Pin.OUT, value=1)
            # https://github.com/crystal-lang/crystal/issues/10820
            oled_reset.off()
            oled_reset.on()
...
if __name__ == "__main__":
    ...
    if i2c is None:
        print("i2c failed or no i2c devices detected. exit")
        sys.exit(1)
    ...
    print("create oled")
    # reset default to None, otherwize
